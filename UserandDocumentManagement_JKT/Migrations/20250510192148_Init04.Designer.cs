...
namespace UserandDocumentManagement_JKT.Migrations
{
    ...
    [Migration("20250510192148_Init04")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserandDocumentManagement_JKT.Models.IngestionStatus", b =>
                {
                    ...
                    b.Property<Guid>("UploadDocumentsId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("UploadDocumentsId");
            ...
            modelBuilder.Entity("UserandDocumentManagement_JKT.Models.UsersProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserandDocumentManagement_JKT.Models.IngestionStatus", b =>
                {
                    b.HasOne("UserandDocumentManagement_JKT.Models.UploadDocument", "UploadDocuments")
                        .WithMany()
                        .HasForeignKey("UploadDocumentsId")
